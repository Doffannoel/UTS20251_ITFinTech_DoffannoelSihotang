    ...
    <div className="items-stretch justify-between space-y-10 lg:flex lg:space-y-0">
      ...
      <div className="basis-[45%]">
        ...
        <div className="mb-5 space-y-1">
          ...
          <h1 className="text-3xl font-medium">{formatIDR(currentPrice)}</h1>
        </div>
              ...
              add(
                {
                  ...
                  name: shoeName,
                  price: currentPrice,
                  image: shots[0] || "/fallback.png", // ambil gambar pertama sebagai cover
                },
                1
              );
              // langsung arahkan ke checkout
              window.location.href = "/checkout?mode=buy_now&slug=" + slug;
            }}
          >
            Buy Now
          </ButtonPrimary>
